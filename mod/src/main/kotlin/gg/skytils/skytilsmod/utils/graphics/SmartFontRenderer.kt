 ...
 * @author Wynntils
 */
class SmartFontRenderer : TextRenderer(
    MinecraftClient.getInstance().options,
    Identifier("textures/font/ascii.png"),
    ...
    private fun drawRainbowText(
        ...
        for (c in input.toCharArray()) {
            val dif = field_0_2819.toLong() * 10 - field_0_2820.toLong() * 10
            ...
            // rendering shadows
            val originPosX = field_0_2819
            val originPosY = field_0_2820
            val offset = if (method_0_2375()) 0.5f else 1f
            when (shadow) {
                TextShadow.OUTLINE -> {
                    RenderSystem.setShaderColor(red * (1 - 0.8f), green * (1 - 0.8f), blue * (1 - 0.8f), 1f)
                    field_0_2819 = originPosX - offset
                    field_0_2820 = originPosY
                    method_0_2379(c)
                    field_0_2819 = originPosX + offset
                    field_0_2820 = originPosY
                    method_0_2379(c)
                    field_0_2819 = originPosX
                    field_0_2820 = originPosY - offset
                    method_0_2379(c)
                    field_0_2819 = originPosX
                    field_0_2820 = originPosY + offset
                    method_0_2379(c)
            ...
            val charLength = method_0_2379(c)
            field_0_2819 += charLength + CHAR_SPACING
        }
        return field_0_2819
    }
    ...
    private fun drawChars(text: String, color: Int, shadow: TextShadow?): Float {
        ...
        while (index < text.length) {
            ...
            when (shadow) {
                TextShadow.OUTLINE -> {
                    field_0_2819 -= offset
                    method_0_2379(character)
                    field_0_2819 += if (bold) offset * 3 else offset * 2
                    method_0_2379(character)
                    var i = 0
            ...
            var charLength = method_0_2379(character, italic)
            if (bold) {
                field_0_2819 += offset
                method_0_2379(character)
                field_0_2819 -= offset
    ...
    private fun method_0_2379(ch: Char, italic: Boolean = false): Float {
        ...
        return if (ch.code == 32) {
            ...
            if (i != -1 && !method_0_2375()) method_0_2380(i, italic) else method_0_2377(ch, italic)
        }
    }
